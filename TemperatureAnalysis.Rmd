...
```
```{r bin 3 plots T, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
grid.arrange(three, six, nine, nrow = 1)
```
```{r bin 3 plots HI, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
...
```
```{r bin 2 plots T, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
grid.arrange(two, five, eight, nrow = 1)
```
```{r bin 2 plots HI, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
...
```
```{r bin 1 plots T, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
grid.arrange(one, four, seven, nrow = 1)
```
```{r bin 1 plots HI, fig.height = 2.5, fig.width = 7.5, echo=FALSE}
